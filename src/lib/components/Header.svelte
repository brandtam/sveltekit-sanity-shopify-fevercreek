			...
			<div class="fixed inset-0 z-40 flex">
				...
				>
					...
					<div class="mt-2">
						...
						<div
							id="tabs-1-panel-1"
							class="{selected === 'Guitars' ? 'block' : 'hidden'} space-y-10 px-4 pb-8 pt-10"
													...
													<!-- <div class="grid grid-cols-3 gap-x-8 gap-y-10 text-sm text-gray-500">
														<div class="space-y-10">
															...
															<div>
																...
																<ul
																	role="list"
																	aria-labelledby="women-collection-heading"
																	class="mt-4 space-y-4"
																>
																	<li class="flex">
														...
														<div class="space-y-10">
															<div>
																...
																<ul
																	role="list"
																	aria-labelledby="women-clothing-heading"
																	class="mt-4 space-y-4"
																>
																	<li class="flex">
														...
														<div class="space-y-10">
															<div>
																...
																<ul
																	role="list"
																	aria-labelledby="women-brands-heading"
																	class="mt-4 space-y-4"
																>
																	<li class="flex">
